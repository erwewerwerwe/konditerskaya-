...
class Product(models.Model):
    ...
    slug = models.SlugField(max_length=120, unique=True, verbose_name='URL категории', default='default-slug')
    ...
    def save(self, *args, **kwargs):
        ...
        if self.image:
            ...
            desired_size = (340, 220)  # ширина и высота для всех изображений

            # Изменяем размер с обрезкой, чтобы точно вписать в нужный размер
